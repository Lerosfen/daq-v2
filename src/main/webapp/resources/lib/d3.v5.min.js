...
!function(t, n) {
    ...
    var Te, Se, ke, Ee, Ce = 180 / Math.PI, Pe = {
        translateX: 0,
        translateY: 0,
        rotate: 0,
        skewX: 0,
    ...
    var De = Re(function(t) {
        return "none" === t ? Pe : (Te || (Te = document.createElement("DIV"),
    ...
    function Yi(n) {
        ...
        function d() {
            if ((!e || t.event.touches) && i.apply(this, arguments)) {
                var r, o, u, c, f, h, d, p, v, g, y, _, b = this, m = t.event.target.__data__.type, x = "selection" === (a && t.event.metaKey ? m = "overlay" : m) ? xi : a && t.event.altKey ? Ni : Mi, w = n === ki ? null : Ri[m], M = n === Si ? null : Di[m], N = Bi(b), A = N.extent, T = N.selection, S = A[0][0], k = A[0][1], E = A[1][0], C = A[1][1], P = 0, z = 0, R = w && M && a && t.event.shiftKey, D = t.event.touches ? (_ = t.event.changedTouches[0].identifier,
                function(n) {
                    return Yt(n, t.event.touches, _)
                }
                ) : Bt, q = D(b), L = q, U = l(b, arguments, !0).beforestart();
                "overlay" === m ? (T && (v = !0),
                N.selection = T = [[r = n === ki ? S : q[0], u = n === Si ? k : q[1]], [f = n === ki ? E : r, d = n === Si ? C : u]]) : (r = T[0][0],
                u = T[0][1],
                f = T[1][0],
                d = T[1][1]),
                o = r,
            ...
            function I() {
                ...
                y && (c = T[0][1],
                p = T[1][1]),
                T[0][0] === o && T[0][1] === c && T[1][0] === h && T[1][1] === p || (N.selection = [[o, c], [h, p]],
                s.call(b),
                U.brush())
            }
            function H() {
        ...
        function g() {
            ...
            return t.extent = Ti(r.apply(this, arguments)),
            t.dim = n,
            t
        }
        ...
        f.extent = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : yi(Ti(t)),
            f) : r
        }
        ,
        f.filter = function(t) {
    ...
    var Ua, Oa = Array.prototype.map, Ba = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Ya(t) {
        var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? La : (n = Oa.call(t.grouping, Number),
        e = t.thousands + "",
        function(t, r) {
        ...
        ), i = void 0 === t.currency ? "" : t.currency[0] + "", o = void 0 === t.currency ? "" : t.currency[1] + "", a = void 0 === t.decimal ? "." : t.decimal + "", u = void 0 === t.numerals ? La : function(t) {
            return function(n) {
                return n.replace(/[0-9]/g, function(n) {
                    return t[+n]
                })
            }
        }(Oa.call(t.numerals, String)), c = void 0 === t.percent ? "%" : t.percent + "", f = void 0 === t.minus ? "-" : t.minus + "", s = void 0 === t.nan ? "NaN" : t.nan + "";
        function l(t) {
            var n = (t = za(t)).fill
              , e = t.align
              , l = t.sign
            ...
            function M(t) {
                ...
                switch (v && d && (t = r(T + t, T.length ? p - M.length : 1 / 0),
                T = ""),
                e) {
                case "<":
                    t = h + t + M + T;
    ...
    var Au, Tu, Su, ku, Eu, Cu = Xa(), Pu = Xa(), zu = {
        point: _u,
        lineStart: _u,
        lineEnd: _u,
    ...
    var ju, Xu, Gu, Vu, $u, Wu, Zu, Qu, Ku, Ju, tc, nc, ec, rc, ic, oc, ac, uc, cc, fc, sc, lc, hc, dc, pc, vc, gc = Xa(), yc = {
        point: _c,
        lineStart: mc,
        lineEnd: xc,
        polygonStart: function() {
        ...
        polygonEnd: function() {
            ...
            yc.lineEnd = xc,
            Cu < 0 ? (ju = -(Gu = 180),
            Xu = -(Vu = 90)) : gc > Wa ? Vu = 90 : gc < -Wa && (Xu = -90),
            Ju[0] = ju,
            Ju[1] = Gu
        },
        sphere: function() {
    ...
    function bc(t, n) {
        ...
        if (Qu) {
            ...
            Hu(i),
            i = Uu(i);
            var o, a = t - $u, u = a > 0 ? 1 : -1, c = i[0] * nu * u, f = ru(a) > 180;
            f ^ (u * $u < c && c < u * t) ? (o = i[1] * nu) > Vu && (Vu = o) : f ^ (u * $u < (c = (c + 360) % 360 - 180) && c < u * t) ? (o = -i[1] * nu) < Xu && (Xu = o) : (n < Xu && (Xu = n),
            n > Vu && (Vu = n)),
            f ? t < $u ? Ac(ju, t) > Ac(ju, Gu) && (Gu = t) : Ac(t, Gu) > Ac(ju, Gu) && (ju = t) : Gu >= ju ? (t < ju && (ju = t),
            t > Gu && (Gu = t)) : t > $u ? Ac(ju, t) > Ac(ju, Gu) && (Gu = t) : Ac(t, Gu) > Ac(ju, Gu) && (ju = t)
        } else
            Ku.push(Ju = [ju = t, Gu = t]);
        n < Xu && (Xu = n),
        n > Vu && (Vu = n),
    ...
    function Gc(t) {
        function n(n) {
            return (n = t(n[0] * eu, n[1] * eu))[0] *= nu,
            n[1] *= nu,
            n
        }
        return t = Ic(t[0] * eu, t[1] * eu, t.length > 2 ? t[2] * eu : 0),
        n.invert = function(n) {
            return (n = t.invert(n[0] * eu, n[1] * eu))[0] *= nu,
            n[1] *= nu,
            n
        }
        ,
    ...
    function ef(t, n) {
        var e = nf(n)
          ...
          , u = 0;
        tf.reset(),
        1 === i ? r = Ka + Wa : -1 === i && (r = -Ka - Wa);
        for (var c = 0, f = t.length; c < f; ++c)
            if (l = (s = t[c]).length)
                for (var s, l, h = s[l - 1], d = nf(h), p = h[1] / 2 + Ja, v = lu(p), g = au(p), y = 0; y < l; ++y,
                d = b,
                v = x,
                g = w,
                h = _) {
                    var _ = s[y]
                      ...
                      , T = A > Qa
                      , S = v * x;
                    if (tf.add(ou(S * N * lu(A), g * w + S * au(A))),
                    a += T ? M + N * tu : M,
                    T ^ d >= e ^ b >= e) {
                        var k = Yu(Ou(h), Ou(_));
                        Hu(k);
    ...
    function rf(t, n, e, r) {
        return function(i) {
            var o, a, u, c = n(i), f = Wc(), s = n(f), l = !1, h = {
                point: d,
                lineStart: v,
                lineEnd: g,
                polygonStart: function() {
                ...
                polygonEnd: function() {
                    ...
                    l = !0),
                    Kc(a, af, t, e, i)) : t && (l || (i.polygonStart(),
                    l = !0),
                    i.lineStart(),
                    e(null, null, 1, i),
                    i.lineEnd()),
    ...
    var uf = rf(function() {
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? Qa : -Qa
                  , c = ru(o - e);
                ru(c - Qa) < Wa ? (t.point(e, r = (r + a) / 2 > 0 ? Ka : -Ka),
                t.point(i, r),
                t.lineEnd(),
                t.lineStart(),
                t.point(u, r),
                t.point(o, r),
                n = 0) : i !== u && c >= Qa && (ru(e - i) < Wa && (e -= i * Wa),
                ru(o - u) < Wa && (o -= u * Wa),
                r = function(t, n, e, r) {
                    var i, o, a = lu(t - e);
    ...
    function cf(t) {
        ...
        function a(t, e, r) {
            ...
            if (!(g < 0)) {
                ...
                w = M,
                M = b),
                A || N < Wa ? A ? w + M > 0 ^ _[1] < (ru(_[0] - m) < Wa ? w : M) : w <= _[1] && _[1] <= M : N > Qa ^ (m <= _[0] && _[0] <= x)) {
                    var T = Iu(d, (-p + y) / v);
                    return Fu(T, h),
                    [_, Uu(T)]
                }
        ...
        return rf(o, function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    v !== c && (!(d = a(n, p)) || Zc(n, d) || Zc(p, d)) && (p[0] += Wa,
                    p[1] += Wa,
                    v = o(p[0], p[1])),
                    v !== c)
                        s = 0,
    ...
    function lf(t, n, e, r) {
        ...
        return function(a) {
            var c, f, s, l, h, d, p, v, g, y, _, b = a, m = Wc(), x = {
                point: w,
                lineStart: function() {
                    x.point = M,
                    f && f.push(s = []);
    ...
    var Lf, Uf, Of, Bf, Yf = Xa(), Ff = Xa(), If = {
        point: _u,
        lineStart: _u,
        lineEnd: _u,
        polygonStart: function() {
    ...
    var Vf = 1 / 0
      ...
      , Qf = {
        ...
        result: function() {
            var t = [[Vf, $f], [Wf, Zf]];
            return Wf = Zf = -($f = Vf = 1 / 0),
            t
        }
    };
    var Kf, Jf, ts, ns, es = 0, rs = 0, is = 0, os = 0, as = 0, us = 0, cs = 0, fs = 0, ss = 0, ls = {
        point: hs,
        lineStart: ds,
        lineEnd: gs,
        polygonStart: function() {
        ...
        result: function() {
            ...
            return es = rs = is = os = as = us = cs = fs = ss = 0,
            t
        }
    };
    function hs(t, n) {
        ...
        return +n ? function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    var m = a + h
                      ...
                      , C = k - i
                      , P = _ * E - y * C;
                    (P * P / b > n || ru((y * E + _ * C) / b - .5) > .3 || a * h + u * d + c * p < Fs) && (e(r, i, o, a, u, c, S, k, A, m /= M, x /= M, w, v, g),
                    g.point(S, k),
            ...
            return function(n) {
                ...
                function _(r, i) {
                    var o = Ou([r, i])
                      , a = t(r, i);
                    e(s, l, f, h, d, p, s = a[0], l = a[1], f = r, h = o[0], d = o[1], p = o[2], Ys, n),
                    n.point(s, l)
                }
                function b() {
                    v.point = g,
    ...
    function Gs(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, v = 0, g = 0, y = 0, _ = 0, b = 0, m = null, x = uf, w = null, M = qf, N = .5;
        function A(t) {
        ...
        A.clipAngle = function(t) {
            return arguments.length ? (x = +t ? cf(m = t * eu) : (m = null,
            uf),
            k()) : m * nu
        }
        ,
        A.clipExtent = function(t) {
            ...
            qf) : lf(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]),
        ...
        ,
        A.center = function(t) {
            return arguments.length ? (p = t[0] % 360 * eu,
            v = t[1] % 360 * eu,
            S()) : [p * nu, v * nu]
        }
        ,
        A.rotate = function(t) {
            return arguments.length ? (g = t[0] % 360 * eu,
            y = t[1] % 360 * eu,
        ...
        ,
        A.angle = function(t) {
            return arguments.length ? (b = t % 360 * eu,
            S()) : b * nu
        }
        ,
        A.precision = function(t) {
            return arguments.length ? (a = Is(u, N = t * t),
            k()) : du(N)
        }
        ,
    ...
    function el(t) {
        var n, e, r, i = Xs(t), o = i.center, a = i.scale, u = i.translate, c = i.clipExtent, f = null;
        function s() {
            var o = Qa * a()
    ...
    hl.invert = function(t, n) {
        for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * (ul + cl * i + o * (fl + sl * i)) - n) / (ul + 3 * cl * i + o * (7 * fl + 9 * sl * i))) * r) * i * i,
        !(ru(e) < Za)); ++a)
            ;
    ...
    function Ch() {
        ...
        ,
        i.range = function(t) {
            return arguments.length ? (e = kh.call(t),
            i) : e.slice()
        }
        ,
    ...
    function Ph() {
        var t, n, e = Ch().unknown(void 0), r = e.domain, i = e.range, o = [0, 1], a = !1, u = 0, c = 0, f = .5;
        function s() {
            var e = r().length
              , s = o[1] < o[0]
              , l = o[s - 0]
    ...
    function Yh() {
        var t, n, e, r, i, o, a = Rh, u = Rh, c = Ne, f = Dh;
        function s() {
            return r = Math.min(a.length, u.length) > 2 ? Oh : Uh,
            i = o = null,
            l
        }
        function l(n) {
        ...
        ,
        l.domain = function(t) {
            return arguments.length ? (a = Sh.call(t, zh),
            f === Dh || (f = Lh(a)),
            s()) : a.slice()
        }
        ,
        l.range = function(t) {
            return arguments.length ? (u = kh.call(t),
            s()) : u.slice()
        }
        ,
        ...
        ,
        l.clamp = function(t) {
            return arguments.length ? (f = t ? Lh(a) : Dh,
            l) : f !== Dh
        }
        ,
    ...
    function Ih(n, e, r, i) {
        ...
        case "s":
            ...
            return null != i.precision || isNaN(o = Ha(a, u)) || (i.precision = o),
            t.formatPrefix(i, u);
        case "":
        case "e":
        case "g":
    ...
    function Qh(n) {
        var e, r, i = n(Xh, Gh), o = i.domain, a = 10;
        function u() {
            return e = function(t) {
    ...
    fd.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? cd(function(n) {
            ...
            return function(e) {
                ...
                "V"in o) {
                    if (o.V < 1 || o.V > 53)
                        return null;
                    "w"in o || (o.w = 1),
                    "Z"in o ? (i = (r = hp(dp(o.y))).getUTCDay(),
                    r = i > 4 || 0 === i ? $d.ceil(r) : $d(r),
                    r = jd.offset(r, 7 * (o.V - 1)),
                    o.y = r.getUTCFullYear(),
                    o.m = r.getUTCMonth(),
                    o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = n(dp(o.y))).getDay(),
                    ...
                    i = "Z"in o ? hp(dp(o.y)).getUTCDay() : n(dp(o.y)).getDay(),
                    o.m = 0,
    ...
    function yv(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? Qd(t) : Qd.ceil(t),
    ...
    function Bv() {
        var t, n, e, r, i, o = 0, a = 1, u = Dh, c = !1;
        function f(n) {
    ...
    function Iv() {
        var t, n, e, r, i, o, a, u = 0, c = .5, f = 1, s = Dh, l = !1;
        function h(t) {
    ...
    function Uy() {
        ...
        return a.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : py(+n),
            a) : t
        }
        ,
        a.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : py(+t),
            a) : n
        }
        ,
        a.defined = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : py(!!t),
            a) : e
        }
        ,
        a.curve = function(t) {
    ...
    function Oy() {
        ...
        return c.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : py(+e),
            n = null,
            c) : t
        }
        ,
        ...
        ,
        c.x1 = function(t) {
            return arguments.length ? (n = null == t ? null : "function" == typeof t ? t : py(+t),
            c) : n
        }
        ,
        c.y = function(t) {
        ...
        ,
        c.y1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : py(+t),
            c) : r
        }
        ,
        ...
        c.defined = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : py(!!t),
            c) : i
        }
        ,
        c.curve = function(t) {
    ...
    function Qy(t) {
        var n = Wy
          ...
          , o = null;
        function a() {
            var a, u = $y.call(arguments), c = n.apply(this, u), f = e.apply(this, u);
            if (o || (o = a = to()),
        ...
        ,
        a.x = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : py(+t),
            a) : r
        }
        ,
        a.y = function(t) {
    ...
    var n_ = {
      ...
      , g_ = {
        draw: function(t, n) {
            ...
            t.lineTo(-.5 * u - d_ * c, d_ * u + -.5 * c),
            t.lineTo(-.5 * r + d_ * i, -.5 * i - d_ * r),
            t.lineTo(-.5 * o + d_ * a, -.5 * a - d_ * o),
            t.lineTo(-.5 * u + d_ * c, -.5 * c - d_ * u),
            t.closePath()
        }
    }
        ...
        lineEnd: function() {
            ...
            if (e)
                ...
                2 === e)
                    ...
                    for (var r = $_(t), i = $_(n), o = 0, a = 1; a < e; ++o,
                    ++a)
    ...
    function kb(t) {
        ...
        u.unshift(c),
        Mb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < Lb && Math.abs(r - f.circle.cy) < Lb; )
            a = f.N,
            u.push(f),
            Sb(f),
            f = a;
    ...
    var zb, Rb, Db, qb, Lb = 1e-6, Ub = 1e-12;
    function Ob(t, n, e) {
    ...
    function Yb(t, n) {
        ...
        n) {
            ...
            function(t, n, e, r) {
                var i, o, a, u, c, f, s, l, h, d, p, v, g = Rb.length, y = !0;
                for (i = 0; i < g; ++i)
                    if (o = Rb[i]) {
                        for (a = o.site,
                        ...
                        f = c.length; u < f; )
                            ...
                            l = (s = yb(o, qb[c[++u % f]]))[0],
                            h = s[1],
                            (Math.abs(p - l) > Lb || Math.abs(v - h) > Lb) && (c.splice(u, 0, qb.push(hb(a, d, Math.abs(p - t) < Lb && r - v > Lb ? [t, Math.abs(l - t) < Lb ? h : r] : Math.abs(v - r) < Lb && e - p > Lb ? [Math.abs(h - r) < Lb ? l : e, r] : Math.abs(p - e) < Lb && v - n > Lb ? [e, Math.abs(l - e) < Lb ? h : n] : Math.abs(v - n) < Lb && p - t > Lb ? [Math.abs(h - n) < Lb ? l : t, n] : null)) - 1),
                            ++f);
                        f && (y = !1)
                    }
                if (y) {
                    ...
                    for (i = 0,
                    y = null; i < g; ++i)
                        (o = Rb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && (x = m,
                        y = o);
                    if (y) {
                        var w = [t, n]
                          , M = [t, r]
    ...
    t.arc = function() {
        var t = Sy
          ...
          , u = null;
        function c() {
            var c, f, s = +t.apply(this, arguments), l = +n.apply(this, arguments), h = i.apply(this, arguments) - Ny, d = o.apply(this, arguments) - Ny, p = vy(d - h), v = d > h;
            if (u || (u = c = to()),
            l < s && (f = l,
            l = s,
            s = f),
            l > wy)
                if (p > Ay - wy)
                    ...
                    u.arc(0, 0, l, h, d, !v),
                    s > wy && (u.moveTo(s * yy(d), s * my(d)),
                    u.arc(0, 0, s, d, h, v));
                else {
                    var g, y, _ = h, b = d, m = h, x = d, w = p, M = p, N = a.apply(this, arguments) / 2, A = N > wy && (r ? +r.apply(this, arguments) : xy(s * s + l * l)), T = by(vy(l - s) / 2, +e.apply(this, arguments)), S = T, k = T;
                    if (A > wy) {
                        var E = Ty(A / s * my(N))
                          , C = Ty(A / l * my(N));
                        (w -= 2 * E) > wy ? (m += E *= v ? 1 : -1,
                    ...
                    var P = l * yy(_)
                      ...
                      , D = s * my(x);
                    if (T > wy) {
                        var q, L = l * yy(b), U = l * my(b), O = s * yy(m), B = s * my(m);
                    ...
                    M > wy ? k > wy ? (g = zy(O, B, P, z, l, k, v),
                    y = zy(L, U, R, D, l, k, v),
                    u.moveTo(g.cx + g.x01, g.cy + g.y01),
                    k < T ? u.arc(g.cx, g.cy, k, gy(g.y01, g.x01), gy(y.y01, y.x01), !v) : (u.arc(g.cx, g.cy, k, gy(g.y01, g.x01), gy(g.y11, g.x11), !v),
                    u.arc(0, 0, l, gy(g.cy + g.y11, g.cx + g.x11), gy(y.cy + y.y11, y.cx + y.x11), !v),
                    u.arc(y.cx, y.cy, k, gy(y.y11, y.x11), gy(y.y01, y.x01), !v))) : (u.moveTo(P, z),
                    u.arc(0, 0, l, _, b, !v)) : u.moveTo(P, z),
                    s > wy && w > wy ? S > wy ? (g = zy(R, D, L, U, s, -S, v),
                    y = zy(P, z, O, B, s, -S, v),
                    u.lineTo(g.cx + g.x01, g.cy + g.y01),
                    S < T ? u.arc(g.cx, g.cy, S, gy(g.y01, g.x01), gy(y.y01, y.x01), !v) : (u.arc(g.cx, g.cy, S, gy(g.y01, g.x01), gy(g.y11, g.x11), !v),
                    u.arc(0, 0, s, gy(g.cy + g.y11, g.cx + g.x11), gy(y.cy + y.y11, y.cx + y.x11), v),
                    u.arc(y.cx, y.cy, S, gy(y.y11, y.x11), gy(y.y01, y.x01), !v))) : u.arc(0, 0, s, x, m, v) : u.lineTo(R, D)
                }
            else
                u.moveTo(0, 0);
            if (u.closePath(),
        ...
        c.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : py(+t),
            c) : o
        }
        ,
        c.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : py(+t),
            c) : a
        }
        ,
        c.context = function(t) {
    ...
    t.forceManyBody = function() {
        ...
        function c(r) {
            var i, o = t.length, a = ga(t, Na, Aa).visitAfter(s);
            for (e = r,
            i = 0; i < o; ++i)
                n = t[i],
                a.visit(l)
    ...
    t.geoAlbersUsa = function() {
        var t, n, e, r, i, o, a = Zs(), u = Ws().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), c = Ws().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
            point: function(t, n) {
                o = [t, n]
            }
        };
        ...
        s.translate = function(t) {
            ...
            r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[o - .425 * n + Wa, s + .12 * n + Wa], [o - .214 * n - Wa, s + .234 * n - Wa]]).stream(f),
            i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[o - .214 * n + Wa, s + .166 * n + Wa], [o - .115 * n - Wa, s + .234 * n - Wa]]).stream(f),
            l()
        }
        ,
    ...
    t.geoBounds = function(t) {
        ...
        e = Ku.length) {
            ...
            n = 1,
            o = [r = Ku[0]]; n < e; ++n)
                Sc(r, (i = Ku[n])[0]) || Sc(r, i[1]) ? (Ac(r[0], i[1]) > Ac(r[0], r[1]) && (r[1] = i[1]),
                Ac(i[0], r[1]) > Ac(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0,
            n = 0,
        ...
        return Ku = Ju = null,
        ju === 1 / 0 || Xu === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[ju, Xu], [Gu, Vu]]
    }
    ,
    t.geoCentroid = function(t) {
        ...
        e = rc,
        r = ic),
        (i = n * n + e * e + r * r) < Za) ? [NaN, NaN] : [ou(e, n) * nu, gu(r / du(i)) * nu]
    }
    ,
    t.geoCircle = function() {
        var t, n, e = Bc([0, 0]), r = Bc(90), i = Bc(6), o = {
            point: function(e, r) {
                t.push(e = n(e, r)),
                e[0] *= nu,
                e[1] *= nu
        ...
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Bc([+t[0], +t[1]]),
            a) : e
        }
        ,
        a.radius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Bc(+t),
            a) : r
        }
        ,
        a.precision = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Bc(+t),
            a) : i
        }
        ,
        a
    ...
    t.geoIdentity = function() {
        var t, n, e, r, i, o, a = 1, u = 0, c = 0, f = 1, s = 1, l = qf, h = null, d = qf;
        function p() {
            return r = i = null,
            o
        }
        return o = {
            ...
            clipExtent: function(r) {
                ...
                qf) : lf(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]),
                p()) : null == h ? null : [[h, t], [n, e]]
            },
            scale: function(t) {
                return arguments.length ? (l = pl((a = +t) * f, a * s, u, c),
                p()) : a
            },
            translate: function(t) {
                return arguments.length ? (l = pl(a * f, a * s, u = +t[0], c = +t[1]),
                p()) : [u, c]
            },
            reflectX: function(t) {
                return arguments.length ? (l = pl(a * (f = t ? -1 : 1), a * s, u, c),
                p()) : f < 0
            },
            reflectY: function(t) {
                return arguments.length ? (l = pl(a * f, a * (s = t ? -1 : 1), u, c),
                p()) : s < 0
            },
    ...
    t.pack = function() {
        ...
        function i(i) {
            return i.x = n / 2,
            i.y = e / 2,
            t ? i.eachBefore(Vl(t)).eachAfter($l(r, .5)).eachBefore(Wl(1)) : i.eachBefore(Vl(Gl)).eachAfter($l(jl, 1)).eachAfter($l(r, i.r / Math.min(n, e))).eachBefore(Wl(Math.min(n, e) / (2 * i.r))),
            i
        }
        ...
        i.padding = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Xl(+t),
            i) : r
        }
        ,
        i
    ...
    t.pie = function() {
        var t = Yy
          ...
          , o = py(0);
        function a(a) {
            var u, c, f, s, l, h = a.length, d = 0, p = new Array(h), v = new Array(h), g = +r.apply(this, arguments), y = Math.min(Ay, Math.max(-Ay, i.apply(this, arguments) - g)), _ = Math.min(Math.abs(y) / h, o.apply(this, arguments)), b = _ * (y < 0 ? -1 : 1);
            for (u = 0; u < h; ++u)
    ...
    t.scaleIdentity = function t(n) {
        ...
        r.domain = r.range = function(t) {
            return arguments.length ? (n = Sh.call(t, zh),
            r) : n.slice()
        }
        ,
    ...
    t.scaleQuantile = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = kh.call(t),
            u()) : o.slice()
        }
        ,
    ...
    t.scaleQuantize = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = (u = kh.call(t)).length - 1,
            f()) : u.slice()
        }
        ,
    ...
    t.scaleThreshold = function t() {
        ...
        ,
        a.range = function(t) {
            return arguments.length ? (r = kh.call(t),
            o = Math.min(e.length, r.length - 1),
            a) : r.slice()
        }
        ,
    ...
    t.stack = function() {
        ...
        return i.keys = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : py($y.call(n)),
            i) : t
        }
        ,
        i.value = function(t) {
        ...
        ,
        i.order = function(t) {
            return arguments.length ? (n = null == t ? Q_ : "function" == typeof t ? t : py($y.call(t)),
            i) : n
        }
        ,
        i.offset = function(t) {
            return arguments.length ? (e = null == t ? Z_ : t,
            i) : e
        }
        ,
        i
    ...
    t.stackOrderInsideOut = function(t) {
        var n, e, r = t.length, i = t.map(eb), o = J_(t), a = 0, u = 0, c = [], f = [];
        for (n = 0; n < r; ++n)
            e = o[n],
            a < u ? (a += i[e],
            c.push(e)) : (u += i[e],
    ...
    t.stratify = function() {
        ...
        return e.id = function(n) {
            return arguments.length ? (t = Hl(n),
            e) : t
        }
        ,
        e.parentId = function(t) {
            return arguments.length ? (n = Hl(t),
            e) : n
        }
        ,
        e
    ...
    t.tree = function() {
                ...
                for (var n, e, r, i, o, a = new ch(t,0), u = [a]; n = u.pop(); )
                    if (r = n._.children)
                        ...
                        i = o - 1; i >= 0; --i)
                            ...
                            e.parent = n;
                return (a.parent = new ch(null,0)).children = [a],
                a
            }(i);
            if (c.eachAfter(o),
            c.parent.m = -c.z,
        ...
        function o(n) {
            ...
            n.parent.A = function(n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = oh(u),
                    o = ih(o),
                    u && o; )
                        c = ih(c),
                        (a = oh(a)).a = n,
                        (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (ah(uh(u, n, r), n, i),
                        f += i,
                        s += i),
                        l += u.m,
                        f += o.m,
    ...
    t.treemap = function() {
        ...
        s.paddingInner = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : Xl(+t),
            s) : o
        }
        ,
        ...
        s.paddingTop = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Xl(+t),
            s) : a
        }
        ,
        s.paddingRight = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Xl(+t),
            s) : u
        }
        ,
        s.paddingBottom = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : Xl(+t),
            s) : c
        }
        ,
        s.paddingLeft = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : Xl(+t),
            s) : f
        }
        ,
        s
    ...
    ,
    t.zoom = function() {
        var n, e, r = $b, i = Wb, o = Jb, a = Qb, u = Kb, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, l = Fe, h = I("start", "zoom", "end"), d = 500, p = 150, v = 0;
        function g(t) {
        ...
        g.wheelDelta = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Fb(+t),
            g) : a
        }
        ,
        g.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Fb(!!t),
            g) : r
        }
        ,
        g.touchable = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Fb(!!t),
            g) : u
        }
        ,
        g.extent = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Fb([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            g) : i
        }
        ,
